...
try:
    response = client.files_upload(
        ...
        initial_comment="""_CHD Performance Report_"""
    )
...
try:
    response = client.files_upload(
        channels=channel,
        file=image_path,
        title='_eVTF Performance Report_',
        initial_comment="""_eVTF Performance Report_"""
    )
...
try:
    response = client.files_upload(
        channels=channel,
        file=image_path,
        title='Slot Adherence || C2B Pickup',
        initial_comment="""Slot Adherence || C2B Pickup"""
    )
...
try:
    response = client.files_upload(
        channels=channel,
        file=image_path,
        title='CSP Perfomance || C2B Pickup',
        initial_comment="""CSP Perfomance || C2B Pickup"""
    )
